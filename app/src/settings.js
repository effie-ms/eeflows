...
export const loadSettings = () => {
    ...
    if (process.env.BUILD_TARGET === 'server') {
        ...
        cfg.LOGGING_DIR = process.env.RAZZLE_LOGGING_DIR || '/var/log/eeflows/';
