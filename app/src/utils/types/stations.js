...
export const EflowsShape = PropTypes.shape({
    ...
    min_exceeds_low_eflow: PropTypes.boolean,
    avg_exceeds_low_eflow: PropTypes.boolean,
    avg_exceeds_low_eflow_forecast: PropTypes.boolean,
    max_exceeds_low_eflow: PropTypes.boolean,
    min_exceeds_base_eflow: PropTypes.boolean,
    avg_exceeds_base_eflow: PropTypes.boolean,
    avg_exceeds_base_eflow_forecast: PropTypes.boolean,
    max_exceeds_base_eflow: PropTypes.boolean,
    min_exceeds_subsistence_eflow: PropTypes.boolean,
    avg_exceeds_subsistence_eflow: PropTypes.boolean,
    avg_exceeds_subsistence_eflow_forecast: PropTypes.boolean,
    max_exceeds_subsistence_eflow: PropTypes.boolean,
    min_exceeds_critical_eflow: PropTypes.boolean,
    avg_exceeds_critical_eflow: PropTypes.boolean,
    avg_exceeds_critical_eflow_forecast: PropTypes.boolean,
    max_exceeds_critical_eflow: PropTypes.boolean,
    min_exceeds_second_axis_ts: PropTypes.boolean,
    max_exceeds_second_axis_ts: PropTypes.boolean,
    avg_exceeds_second_axis_ts: PropTypes.boolean,
    avg_exceeds_second_axis_ts_forecast: PropTypes.boolean,
});
...
export const EflowsResponseShape = PropTypes.shape({
    ...
    second_axis_threshold: PropTypes.number.isRequired,
